...
export default function AxeLumberjackPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-between min-h-screen bg-background p-4 sm:p-8 font-body overflow-hidden relative">
      <audio ref={chopSoundRef} src="https://static.wikia.nocookie.net/dota2_gamepedia/images/c/c8/Weapons_hero_axe_attack01.mp3" preload="auto"></audio>
      <audio ref={fellSoundRef} src="https://static.wikia.nocookie.net/dota2_gamepedia/images/4/47/Weapons_hero_axe_culling_blade_success.mp3" preload="auto"></audio>
